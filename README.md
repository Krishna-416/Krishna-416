...
I am a **Student in Dezyne `Ecole College** specializing in the design and execution of resilient, fault-tolerant distributed systems and enterprise-scale machine learning workflows. With a strong foundation in computer science and a product engineering mindset, I bridge the gap between complex research models and mission-critical production software.

*   **Software Engineering:** Expert in microservice architectures, event-driven design, and low-latency API infrastructure capable of serving millions of concurrent requests.
*   **AI/ML Expertise:** Specialized in Large Language Model (LLM) fine-tuning, RAG (Retrieval-Augmented Generation) architectures, high-performance inference optimization, and MLOps automation.
*   **Full Stack Mastery:** Proficient in building modern, accessible, and performant user interfaces backed by scalable cloud-native microservices.
*   **Product Engineering:** Focused on end-to-end delivery—translating strategic business requirements into measurable technical outcomes, robust codebases, and high availability systems.
...
| :--- | :---: | :--- |
| **Large Language Models (LLMs)** | Advanced | Custom fine-tuning (LoRA, QLoRA), Quantization (GGUF, AWQ), Prompt Engineering |
| **Retrieval-Augmented Generation** | Advanced | Vector DB integration (Pinecone, Qdrant, Milvus), hybrid search, semantic ranking |
| **Computer Vision** | Deep Knowledge | Object detection, segmentation, OpenCV, PyTorch, TensorRT optimization |
| **MLOps & Infrastructure** | Advanced | Automated pipelines with Kubeflow, MLflow, Triton Inference Server, distributed training |
| **Predictive Analytics** | Expert | Time-series forecasting, anomaly detection, XGBoost, Scikit-Learn pipelines |
...
| :--- | :--- |
| **Stack** | C++, CUDA, Python, gRPC, Triton, PyTorch |
| **Scale** | Serves 50k+ QPS with sub-10ms P99 latency |
| **Performance** | 4x throughput increase over baseline vLLM using custom CUDA kernels |
| **Security** | Zero-trust architecture, mTLS, OAuth2 JWT token validation |
| **Impact** | Reduced operational cloud infrastructure costs by 38% |
| **Repository** | [github.com/username/nexus-ai](https://github.com/Krishna-416) |
...
<a href="https://leetcode.com/username">
  <img src="https://img.shields.io/badge/LeetCode-Knight%20%7C%202100%2B%20Rating-FFA116?style=for-the-badge&logo=leetcode&logoColor=black" alt="LeetCode"/>
</a>
<a href="https://geeksforgeeks.org">
  <img src="https://img.shields.io/badge/GeeksforGeeks-Top%201%25%20Rank-298D46?style=for-the-badge&logo=geeksforgeeks&logoColor=white" alt="GeeksforGeeks"/>
</a>
<br/><br/>
<a href="https://hackerrank.com">
  <img src="https://img.shields.io/badge/HackerRank-5%20Stars%20Problem%20Solving-2EC866?style=for-the-badge&logo=hackerrank&logoColor=white" alt="HackerRank"/>
</a>
<a href="https://codechef.com">
  <img src="https://img.shields.io/badge/CodeChef-5%20Star%20Coder-5B4638?style=for-the-badge&logo=codechef&logoColor=white" alt="CodeChef"/>
</a>
